...
The user interacts with a textField that also shows them an error message if the guess was invalid. The user can make multiple guesses and skip to a new word. There will also be a history panel on the side tracking their guesses. 
